...
![Tabela sem borda](../assets/tabelasembora.png)
...
Onde:
- Tamanho: Recebe o valor para definir o tamanho da tabela .
...
<html>
    ...
    <body>
        <table border="1" width="500">
            ...
            <tr>
                <td>Desconto</td>
                <td colspan="2">Cupom 1 - R$ 5,00</td>
            </tr>
            <tr>
                <td>Desconto</td>
                <td colspan="2">Cupom 2 - R$ 3,00</td>
            </tr>
            <tr>
                <td>Total:</td>
                <td colspan="2">R$ 33,00</td>
            </tr>
        </table>
    </body>
</html>
